    ...
    return(
        <>
            <div className="w-full text-white">
                ...
                <div className="absolute bg-trasparent w-[50px] h-full z-10 flex justify-center items-center" onClick={handleScrollBefore} >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
                        </svg>
                    </div>

                    <div className="scrollbar flex h-[225px] gap-4 mt-2 overflow-auto overflow-x-hidden ">
                    ...
                    <div className="absolute end-0 bg-trasparent w-[50px] h-full z-10 flex justify-center items-center" onClick={handleScrollAfter}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
