...
const OurRaccomandation = (props) => {
  
    return(
        <>
            <div className="w-full h-[450px]  flex flex-col align-center justify-center">
           
                <div className="text-white">Ti consigliamo:</div>
                <div className="w-full h-full relative mt-2 bg-[url('https://static.sky.it/images_static/tg24/spettacolo/2019/08/14/James_Cameron/James_Cameron_Avatar.jpg.transform/hero-tablet/ffd5e21ae3ab3803fee4805ee5532d1bc3304f7a/img.jpeg')] bg-center bg-cover bg-no-repeat border-2 rounded-lg border-[RGB(255,187,56)]" onClick={props.click}>
                    <div className="flex absolute w-[80px] h-[75px] bottom-[30px] left-[25px]  hover:fill-yellow-400 hover:text-yellow-400">
                        <svg className="absolute stroke-[rgb(255,187,65)] fill-[rgb(255,187,65)] " xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="star"><path d="M22,10.1c0.1-0.5-0.3-1.1-0.8-1.1l-5.7-0.8L12.9,3c-0.1-0.2-0.2-0.3-0.4-0.4C12,2.3,11.4,2.5,11.1,3L8.6,8.2L2.9,9
                        ...
                        <div className="text-sm text-[rgb(255,187,65)]">8,8</div>
                    </div>
                    <div className="flex z-10 absolute w-full h-full">
              <p className="absolute text-white text-[40px] bottom-[110px] left-[30px]">Avatar - La via dell'acqua</p>
              <div>
