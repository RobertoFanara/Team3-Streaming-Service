...
function Sidebar(){
    return<>
            <div className="absolute top-0 -left-72 flex hover:left-0 ease-in-out duration-500">
                <aside className="flex w-72 flex-col space-y-2 border border-transparent bg-[#1c1c1c] p-2 h-[100vh] text-white">
                    <div className="flex items-center">
                        <label className="mr-3">Cerca:</label>
                        <input type="search" className="bg-transparent p-1 rounded-lg"/>
                    </div>
