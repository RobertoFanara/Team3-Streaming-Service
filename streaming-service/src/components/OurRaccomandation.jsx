    ...
    return(
        <>
            <div className="w-full h-[450px] mt-10 flex flex-col align-center justify-center">
                ...
                <div className="w-full h-full relative mt-2 bg-[url('https://static.sky.it/images_static/tg24/spettacolo/2019/08/14/James_Cameron/James_Cameron_Avatar.jpg.transform/hero-tablet/ffd5e21ae3ab3803fee4805ee5532d1bc3304f7a/img.jpeg')] bg-center bg-cover bg-no-repeat border-2 rounded-lg border-yellow-400">
