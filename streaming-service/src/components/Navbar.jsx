      ...
      <div className="flex justify-center">
        ...
        <div className="flex ml-auto items-center">
          <div className="w-[120px]">
            ...
            <input
              type="text"
              className="bg-[rgb(28,28,28)] w-6/12 text-base mt-[5px] rounded-tr-[5px] rounded-br-[5px]"
              placeholder=" Search"
            />
          </div>
          ...
          <div className="flex">
            <img
              ...
              className="w-[15px] h-[15px] invert-[37%] sepia-[0%] saturate-[1649%] hue-rotate-[338deg] brightness-[96%] contrast-[93%] mt-2.5"
            />
            <img
              src="/src/assets/images/profile.svg"
              className="w-[25px] h-[25px] invert-[37%] sepia-[0%] saturate-[1649%] hue-rotate-[338deg] brightness-[96%] contrast-[93%] mt-[5px]"
            />
          </div>
        </div>
      </div>
